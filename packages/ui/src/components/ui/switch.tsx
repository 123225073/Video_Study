...
interface SwitchProps extends HTMLAttributes<HTMLDivElement> {
  /** Visible text beside the track. Omit or pass empty when the row already has a title. */
  label?: string;
  checked: boolean;
  onToggle: () => void;
  disabled?: boolean;
...
/**
 * Toggle control. Renders a track and optional label; unlabeled uses no extra inset
 * so it sits flush inside settings rows and other titled actions.
 */
    ...
    return (
      <div
        ...
        className={cn(
          ...
          hasLabel && sizeClasses.gap,
          hasLabel && sizeClasses.px,
          hasLabel && (sizeClasses.variant === "compact" ? "py-1" : "py-2"),
