...
### Новые возможности
- Транскрибируйте загрузки на компьютере и отмечайте, кто говорит.
- Делайте ИИ-саммари, переводы и другие тексты по расшифровке.
- Импортируйте локальные аудио- и видеофайлы для транскрипции в приложении.
